...
class postsController {
    ...
    async createPost(req, res, next) {
        try {
            ...
            const result = await postService.createPost(message, req.user.id, isPinned);
            return res.json(result);
        } catch (e) {
            next(e);
        }
    ...
    async editPost(req, res, next) {
        try {
            ...
            return res.json(isEditedPost ? Results.successful("Post is edited successfully") : Results.unsuccessful())
        } catch(e) {
            next(e);
        }
    }
    ...
    async deletePost(req, res, next) {
        try {
            ...
            return res.json(deletedPostResult ? Results.successful("Post deleted successfully") : Results.unsuccessful())
        } catch (e) {
            next(e);
        }
    }
